	...
	return (
		<div className="shadow-md w-full fixed top-0 left-0">
			<div className="md:flex items-center justify-between bg-white py-4 md:px-10 px-7">
				...
				>
					{createLinks.map((createLinks) => (
						<li key={createLinks.name} className="md:ml-8 text-xl md:my-0 my-7">
							<a href={createLinks.link} className="text-gray-800 hover:text-gray-400 duration-500">
								{createLinks.name}
							</a>
						</li>
					))}
